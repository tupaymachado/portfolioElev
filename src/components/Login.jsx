    ...
    return (
        <div className={styles.loginContainer}>
            <div className={styles.iconBg}>
                <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" className="bi bi-shield-lock" viewBox="0 0 16 16">
            ...
            <form onSubmit={handleSubmit} className={styles.loginForm}>
                ...
                <div className={styles.links}>
                    ...
                    <a onClick={() => createAccount()} href='#' >Crie uma conta aqui</a>
                </div>
            </form>
        </div>
    );
